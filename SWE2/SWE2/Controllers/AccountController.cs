        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    SqlDataAdapter sda = new SqlDataAdapter("Select Discriminator From [AspNetUsers] Where Email='" + model.Email + "' ", sqlConnection);
                    DataTable dt = new DataTable();
                    sda.Fill(dt);
                    sqlConnection.Close();
                    String Discriminator = dt.Rows[0][0].ToString();
